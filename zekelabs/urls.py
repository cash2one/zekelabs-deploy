...
urlpatterns += [
   ...
   # url('^blog/(?P<slug>\w*)/$', mezzanine.blog.views.blog_post_detail, name='kbytes_slug'),
    url("^test-new/$", mezzanine.pages.views.page, {"slug": "/"}, name="test-new"),
    ...
    url(r'^search-courses/$', profviews.search_courses, name='search-courses'),
    ...
    url("^termsandcondition", direct_to_template, {"template": "termsandcondition.html"}, name="termsandcondition"),
    url(r'^privacypolicy/$', profviews.privacypolicy, name='privacypolicy'),
